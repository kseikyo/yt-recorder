...
- [ ] `grep 'directory / entry\.' src/yt_recorder/pipeline.py` → 0 matches
- [ ] SyncReport.playlist_failed populated in upload flow
- [ ] SECURITY.md exists with all 4 security measures documented
- [ ] Issue templates block blank issues
- [ ] README documents TranscriptStatus, clean, health, PRs paused
